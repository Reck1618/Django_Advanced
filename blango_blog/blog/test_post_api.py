...
class PostApiTestCase(TestCase):
    def setUp(self):
        self.u1 = get_user_model().objects.create_user(email='test_user1', password='test_password1')
        self.u2 = get_user_model().objects.create_user(email='test_user2', password='test_password2')
